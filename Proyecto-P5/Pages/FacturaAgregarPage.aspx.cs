...
{
    public partial class FacturaAgregarPage : System.Web.UI.Page
    {
        ...
        protected void BtnAgregar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (Proyecto_P5Entities db = new Proyecto_P5Entities())
                {
                    db.spCrearFactura(idEmpleado, fecha, total, TipoPago, idClinte, idProducto);
                }
            }
            catch (Exception)
            {
            ...
            Response.Redirect("ResultadoDeCrearFactura.aspx");
        }
