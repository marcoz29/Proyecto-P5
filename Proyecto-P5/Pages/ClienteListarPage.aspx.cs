...
{
    public partial class ClienteListarPage : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    var Lista = db.spListarCliente().ToList();

                    GvListarCliente.DataSource = Lista;
                    GvListarCliente.DataBind();
                }
            }
            catch
            {
        ...
        protected void BtnFiltrar_Click(object sender, EventArgs e)
        {
            if (TxtFiltrar.Text != "")
            {
                ...
                foreach (GridViewRow row in GvListarCliente.Rows)
                {
