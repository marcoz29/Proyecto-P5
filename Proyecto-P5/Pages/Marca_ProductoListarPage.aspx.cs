...
{
    public partial class Marca_ProductoPage : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    var Lista = db.spListarMarca_Producto();

                    GvListarMarca_Producto.DataSource = Lista;
                    GvListarMarca_Producto.DataBind();
                }
            }
            catch
            {
        ...
        protected void BtnFiltrar_Click(object sender, EventArgs e)
        {
            if (TxtFiltrar.Text != "")
            {
                ...
                foreach (GridViewRow row in GvListarMarca_Producto.Rows)
                {
