...
{
    public partial class FacturaListarPage : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    var Lista = db.spListarFactura().ToList();

                    GvListarFactura.DataSource = Lista;
                    GvListarFactura.DataBind();
                }
            }
            catch
            {
        ...
        protected void BtnFiltrar_Click(object sender, EventArgs e)
        {
            if (TxtFiltrar.Text != "")
            {
                ...
                foreach (GridViewRow row in GvListarFactura.Rows)
                {
