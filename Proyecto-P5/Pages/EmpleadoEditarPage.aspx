<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmpleadoEditarPage.aspx.cs" Inherits="Proyecto_P5.Pages.EmpleadoEditarPage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Editar Empleado</h2>
    <div>
        <div>
            <span>Id</span>
            <asp:TextBox ID="txtIdEmpleado" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
        </div>
        <div>
            <span>Nombre</span>
